...
@property (nonatomic, readwrite, weak) CPTPlotArea *plotArea;
@property (nonatomic, readonly, weak) CPTGridLines *minorGridLines;
@property (nonatomic, readonly, weak) CPTGridLines *majorGridLines;
