...
@property (nonatomic, readwrite, weak)  CPPlotArea *plotArea;
@property (nonatomic, readonly, weak)  CPGridLines *minorGridLines;
@property (nonatomic, readonly, weak) CPGridLines *majorGridLines;
